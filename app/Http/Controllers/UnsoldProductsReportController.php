    ...
    public function index(Request $request)
{
    ...
    ->join('products', 'stock_items.product_id', '=', 'products.product_id') // แก้ไขให้ตรงกับคอลัมน์ในตาราง products
    ->select('stock_items.stock_id', 'stock_items.quantity', 'products.product_name')
    ->get();
