...
<div class="container px-5 my-5 ">
    <div class="container ">
    <h5 class="text-center">ฟอร์มแก้ไขข้อมูลสี</h5>
    <div class="row d-flex justify-content-center">
        <div class="col-md-9  ">
            <div class="form">
                <form method="post" action="{{route('update_shirtcolor',$shirtcolor->color_id)}}" class="mt-5 border p-4 bg-light shadow">
                @csrf
                    <h4 class="mb-3 text-secondary">เพิ่มข้อมูลสี</h4>
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            <label>สีเสื้อ<span class="text-danger">*</span></label>
                            <input type="text" name="color_name" class="form-control" value="{{$shirtcolor->color_name}}" >
                        </div>
                        @error('title')
                            <div class="mb-1">
